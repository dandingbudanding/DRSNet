...
if __name__ == '__main__':
    train_path= "../data/train_siftflow"
    test_path = "../data/val_siftflow"

    src_path="../../SiftFlowDataset/Images/spatial_envelope_256x256_static_8outdoorcategories"
    label_path="../../SiftFlowDataset/label"
